          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`space-y-8 ${mounted ? 'animate-fade-in' : 'opacity-0'}`}>
              ...
              <div className="flex flex-col gap-3 pt-4">
                <Link href="mailto:landry.kel@gmail.com" className="flex items-center gap-3 text-lg font-geist hover:text-frog-green transition-colors group" passHref>
                ...
                <Link href="https://linkedin.com/in/kelli-landry89" target="_blank" className="flex items-center gap-3 text-lg font-geist hover:text-frog-green transition-colors group" passHref>
                  <span className="w-10 h-10 rounded-full bg-frog-green flex items-center justify-center group-hover:scale-110 transition-transform">
                    <svg className="w-5 h-5 text-black-forest" fill="currentColor" viewBox="0 0 24 24">
                ...
                <Link href="https://github.com/kel7774" target="_blank" className="flex items-center gap-3 text-lg font-geist hover:text-frog-green transition-colors group" passHref>
